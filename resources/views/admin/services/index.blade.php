...
<div>
    ...
    <div class="px-sm-5 my-5 border-0 rounded shadow-lg">
            <div class="card-header bg-transparent pb-4">
            <h3 class="mr-3 pb-2 pt-3">Serviços</h3>
            <div class="d-flex justify-content-between mt-3">
                <form action="{{ route('services.search') }}" method="get" class="form-inline">
                    <input class="form-control mr-sm-2" type="search" name="query" placeholder="Pesquisar serviço..." aria-label="Pesquisar">
        ...
        <div class="card-body">
            ...
            <div class="d-flex mt-3 mb-4 row">
                ...
                <div class="col-md-3 d-flex justify-content-center">
                    <div class="card mt-4 mb-3 shadow border-0 roundeed" style="max-width: 18rem;">
